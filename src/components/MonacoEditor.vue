...
const defaultOptions = {
  ...
  renderLineHighlight: "none", // 当前行突出显示方式
  scrollBeyondLastLine: false, // 设置编辑器是否可以滚动到最后一行之后
  readOnly: false, // 是否为只读模式
  lineNumbers: "on",
  lineNumbersMinChars: 0,
  // theme: "vs", //官方自带四种种主题'vs' (default), 'vs-dark', 'hc-black', 'hc-light，也可以自定义主题
  // value: "", //编辑器初始显示文字
  // language: "javascript",
  // fontSize: 13,
...
let editor;
// 自定义移除上下文菜单，在contextmenu为false时无效
